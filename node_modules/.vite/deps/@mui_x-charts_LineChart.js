...
var require_createBreakpoints = __commonJS({
  "node_modules/@mui/system/createTheme/createBreakpoints.js"(exports) {
    ...
    var _excluded43 = ["values", "unit", "step"];
    ...
    function createBreakpoints2(breakpoints) {
      const {
        ...
        unit: unit2 = "px",
        step = 5
      } = breakpoints, other = (0, _objectWithoutPropertiesLoose2.default)(breakpoints, _excluded43);
...
var require_createTheme = __commonJS({
  "node_modules/@mui/system/createTheme/createTheme.js"(exports) {
    ...
    var _excluded43 = ["breakpoints", "palette", "spacing", "shape"];
    function createTheme3(options = {}, ...args) {
      const {
        ...
        spacing: spacingInput,
        shape: shapeInput = {}
      } = options, other = (0, _objectWithoutPropertiesLoose2.default)(options, _excluded43);
...
var require_extendSxProp = __commonJS({
  "node_modules/@mui/system/styleFunctionSx/extendSxProp.js"(exports) {
    ...
    function extendSxProp2(props) {
      const {
        sx: inSx
      } = props, other = (0, _objectWithoutPropertiesLoose2.default)(props, _excluded43);
      const {
        systemProps,
        otherProps
      } = splitProps2(other);
...
var require_createStyled = __commonJS({
  "node_modules/@mui/system/createStyled.js"(exports) {
    ...
    function processStyleArg2(callableStyle, _ref) {
      let {
        ownerState
      } = _ref, props = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded43);
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React25.useCallback((mode2) => {
...
var SeriesContext = React32.createContext({});
if (true) {
...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React32.useMemo(() => formatSeries(series, typeof colors3 === "function" ? colors3(theme.palette.mode) : colors3, dataset), [series, colors3, theme.palette.mode, dataset]);
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const value = React35.useMemo(() => _extends({
    chartId: chartId ?? ""
...
var CartesianContext = React37.createContext({
  xAxis: {},
  yAxis: {},
  xAxisIds: [],
  yAxisIds: []
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React37.useContext(SeriesContext);
  const drawingArea = useDrawingArea();
  const xAxis = React37.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React37.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
// node_modules/@mui/base/utils/useSlotProps.js
var _excluded18 = ["elementType", "externalSlotProps", "ownerState", "skipResolvingSlotProps"];
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded18);
...
var InteractionContext = React41.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React41.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React41.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlighContext = React42.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React42.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React42.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React43.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
function useForceUpdate() {
  const update22 = (0, import_react8.useState)()[1];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react11.useState)(
    () => ({
      inputs,
      result: getResult()
    })
  );
  const committed = (0, import_react11.useRef)();
...
var useOnce = (effect4) => (0, import_react12.useEffect)(effect4, emptyDeps);
var emptyDeps = [];
function usePrev(value) {
  const prevRef = (0, import_react13.useRef)();
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react15.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react15.useRef)(null);
    ...
    const observerRef = (0, import_react15.useRef)();
    useIsomorphicLayoutEffect(() => {
    ...
    (0, import_react15.useEffect)(callback, []);
    useOnce(() => () => {
      const observer2 = observerRef.current;
      each(observer2.deps, (dep) => removeFluidObserver(dep, observer2));
    });
    const usedProps = host2.getComponentProps(props.getValue());
    return React44.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const inherited = (0, import_react17.useContext)(ctx);
  const pause = props.pause || !!inherited.pause, immediate = props.immediate || !!inherited.immediate;
  props = useMemoOne(() => ({ pause, immediate }), [pause, immediate]);
  const { Provider } = ctx;
  return React45.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React45.createContext(init));
...
function useSprings(length, props, deps) {
  ...
  const layoutId = (0, import_react16.useRef)(0);
  const forceUpdate = useForceUpdate();
  const state = (0, import_react16.useMemo)(
    () => ({
      ctrls: [],
      queue: [],
      flush(ctrl, updates2) {
  ...
  const ctrls = (0, import_react16.useRef)([...state.ctrls]);
  const updates = [];
...
var useAnimatedPath = (path2, skipAnimation2) => {
  ...
  const interpolator = React46.useMemo(() => previousPath ? string_default(previousPath, path2) : () => path2, [previousPath, path2]);
  const {
    value
  } = useSpring({
    from: {
...
function useSvgRef() {
  const svgRef = React49.useContext(SvgContext);
  if (svgRef === void 0) {
...
var _excluded19 = ["d", "skipAnimation", "ownerState"];
...
function AnimatedArea(props) {
  ...
  const {
    ...
    to: {
      animatedWidth: width2 + left3 + right3
    },
    reset: false,
    immediate: skipAnimation2
  });
  ...
  return (0, import_jsx_runtime21.jsxs)(React51.Fragment, {
    children: [(0, import_jsx_runtime21.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime21.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      })
    }), (0, import_jsx_runtime21.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime21.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
true ? AnimatedArea.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  d: import_prop_types21.default.string.isRequired,
  ownerState: import_prop_types21.default.shape({
...
var _excluded20 = ["id", "classes", "color", "gradientId", "highlightScope", "slots", "slotProps", "onClick"];
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(Area, _extends({}, other, areaProps));
}
true ? AreaElement.propTypes = {
  ...
  d: import_prop_types22.default.string.isRequired,
...
function useChartGradient() {
  const {
    chartId
  } = React55.useContext(DrawingContext);
  return React55.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime25.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime25.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime25.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var _excluded21 = ["slots", "slotProps", "onItemClick", "skipAnimation"];
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime26.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime26.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color3,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React57.Fragment, {
    children: [(0, import_jsx_runtime27.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime27.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      })
    }), (0, import_jsx_runtime27.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime27.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path2
      }))
    })]
...
var _excluded25 = ["id", "classes", "color", "gradientId", "highlightScope", "slots", "slotProps", "onClick"];
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime29.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime29.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color3,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var _excluded27 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React61.forwardRef(function ChartsSurface2(props, ref) {
  ...
  return (0, import_jsx_runtime30.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
...
var ChartContainer = React62.forwardRef(function ChartContainer2(props, ref) {
  const {
    width: width2,
    height: height2,
    series,
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime31.jsx)(DrawingProvider, {
    width: width2,
    height: height2,
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime31.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime31.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime31.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime31.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime31.jsxs)(ChartsSurface, {
              width: width2,
              height: height2,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime31.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React63.useRef(false);
  const [width2, setWidth] = React63.useState(0);
  const [height2, setHeight] = React63.useState(0);
  const computeSize = React63.useCallback(() => {
...
var ResponsiveChartContainer = React64.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded28);
  const [containerRef, width2, height2] = useChartContainerDimensions(inWidth, inHeight);
  return (0, import_jsx_runtime32.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width2 && height2 ? (0, import_jsx_runtime32.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
var _excluded29 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "highlightScope", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(MarkElementPath, _extends({}, other, {
    style: {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime34.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime34.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded31 = ["x", "y", "style", "text", "ownerState"];
var _excluded210 = ["angle", "textAnchor", "dominantBaseline"];
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded31);
  const _ref = styleProps ?? {}, {
    angle,
    textAnchor,
    dominantBaseline
  } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded210);
  const wordsByLines = React67.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime35.jsx)("text", _extends({}, textProps, {
    x: x2,
    y: y2,
    textAnchor,
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime35.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types32.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types32.default.bool,
  ownerState: import_prop_types32.default.any,
  /**
   ...
   * Text displayed.
   */
  text: import_prop_types32.default.string.isRequired
} : void 0;
...
var _excluded33 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxis(inProps) {
  ...
  const {
    xAxisIds
  } = React69.useContext(CartesianContext);
  const _React$useContext = React69.useContext(CartesianContext), _ref = props.axisId ?? xAxisIds[0], {
    xAxis: {
      [_ref]: {
        scale: xScale,
        tickNumber,
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.xAxis[_ref], _excluded33);
  ...
  return (0, import_jsx_runtime36.jsxs)(AxisRoot, {
    transform: `translate(0, ${position2 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime36.jsx)(Line, _extends({
      x1: xScale.range()[0],
      x2: xScale.range()[1],
      ...
      return (0, import_jsx_runtime36.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime36.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime36.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime36.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime36.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
true ? ChartsXAxis.propTypes = {
   ...
   */
  labelFontSize: import_prop_types33.default.number,
  /**
   ...
   */
  position: import_prop_types33.default.oneOf(["bottom", "top"]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  tickFontSize: import_prop_types33.default.number,
  /**
...
var _excluded34 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const {
    yAxisIds
  } = React70.useContext(CartesianContext);
  const _React$useContext = React70.useContext(CartesianContext), _ref = props.axisId ?? yAxisIds[0], {
    yAxis: {
      [_ref]: {
        scale: yScale,
        tickNumber
  ...
  } = _React$useContext, settings = _objectWithoutPropertiesLoose(_React$useContext.yAxis[_ref], _excluded34);
  ...
  return (0, import_jsx_runtime37.jsxs)(AxisRoot, {
    transform: `translate(${position2 === "right" ? left3 + width2 : left3}, 0)`,
    className: classes.root,
    children: [!disableLine && (0, import_jsx_runtime37.jsx)(Line, _extends({
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      className: classes.line
      ...
      return (0, import_jsx_runtime37.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime37.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime37.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime37.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime37.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React71.Fragment, {
    children: [topId && (0, import_jsx_runtime38.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime38.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime38.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime38.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types35.default.oneOfType([import_prop_types35.default.object, import_prop_types35.default.string]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types35.default.oneOfType([import_prop_types35.default.object, import_prop_types35.default.string]),
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types35.default.oneOfType([import_prop_types35.default.object, import_prop_types35.default.string]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default null
   */
  topAxis: import_prop_types35.default.oneOfType([import_prop_types35.default.object, import_prop_types35.default.string])
} : void 0;
...
var Portal = React72.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React72.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React72.isValidElement(children)) {
      ...
      return React72.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime39.jsx)(React72.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime39.jsx)(React72.Fragment, {
...
var _excluded35 = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"];
...
var Popper = React73.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime40.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime40.jsx)(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(React74.Fragment, {
...
function useMouseTracker() {
  const svgRef = React75.useContext(SvgContext);
  const [mousePosition, setMousePosition] = React75.useState(null);
  React75.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime42.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime42.jsx)("tbody", {
        children: (0, import_jsx_runtime42.jsxs)(ChartsTooltipRow, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types39.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types39.default.shape({
    dataIndex: import_prop_types39.default.number,
    seriesId: import_prop_types39.default.oneOfType([import_prop_types39.default.number, import_prop_types39.default.string]).isRequired,
    type: import_prop_types39.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
var ZAxisContext = React77.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React77.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
  ...
  return (0, import_jsx_runtime43.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
true ? ZAxisContextProvider.propTypes = {
   ...
   */
  zAxis: import_prop_types40.default.arrayOf(import_prop_types40.default.shape({
    colorMap: import_prop_types40.default.oneOfType([import_prop_types40.default.shape({
      colors: import_prop_types40.default.arrayOf(import_prop_types40.default.string).isRequired,
      type: import_prop_types40.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types40.default.string,
      values: import_prop_types40.default.arrayOf(import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number, import_prop_types40.default.string]).isRequired)
    }), import_prop_types40.default.shape({
      color: import_prop_types40.default.oneOfType([import_prop_types40.default.arrayOf(import_prop_types40.default.string.isRequired), import_prop_types40.default.func]).isRequired,
      ...
      type: import_prop_types40.default.oneOf(["continuous"]).isRequired
    }), import_prop_types40.default.shape({
      colors: import_prop_types40.default.arrayOf(import_prop_types40.default.string).isRequired,
      thresholds: import_prop_types40.default.arrayOf(import_prop_types40.default.oneOfType([import_prop_types40.default.instanceOf(Date), import_prop_types40.default.number]).isRequired).isRequired,
      type: import_prop_types40.default.oneOf(["piecewise"]).isRequired
    })]),
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React78.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
  ...
  const {
    zAxis,
    zAxisIds
  } = React78.useContext(ZAxisContext);
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types41.default.shape({
    classes: import_prop_types41.default.object,
    getColor: import_prop_types41.default.func,
    itemData: import_prop_types41.default.shape({
      ...
      type: import_prop_types41.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types41.default.object,
...
var _excluded36 = ["align", "className", "component", "gutterBottom", "noWrap", "paragraph", "variant", "variantMapping"];
...
var Typography = React79.forwardRef(function Typography2(inProps, ref) {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime46.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime46.jsx)("thead", {
        children: (0, import_jsx_runtime46.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime46.jsx)(ChartsTooltipCell, {
            colSpan: 3,
      ...
      }), (0, import_jsx_runtime46.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime46.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime46.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: (0, import_jsx_runtime46.jsx)(ChartsTooltipMark, {
                color: getColor6(dataIndex) ?? color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime46.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime46.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types43.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types43.default.shape({
    x: import_prop_types43.default.shape({
      index: import_prop_types43.default.number,
      value: import_prop_types43.default.oneOfType([import_prop_types43.default.instanceOf(Date), import_prop_types43.default.number, import_prop_types43.default.string]).isRequired
    }),
    y: import_prop_types43.default.shape({
      index: import_prop_types43.default.number,
      value: import_prop_types43.default.oneOfType([import_prop_types43.default.instanceOf(Date), import_prop_types43.default.number, import_prop_types43.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types43.default.oneOfType([import_prop_types43.default.instanceOf(Date), import_prop_types43.default.number, import_prop_types43.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React81.useContext(CartesianContext);
  const {
    zAxisIds,
    zAxis
  } = React81.useContext(ZAxisContext);
  const series = React81.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React81.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React81.useMemo(() => {
  ...
  return (0, import_jsx_runtime47.jsx)(Content, _extends({}, chartTooltipContentProps));
}
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types44.default.shape({
    x: import_prop_types44.default.shape({
      index: import_prop_types44.default.number,
      value: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number, import_prop_types44.default.string]).isRequired
    }),
    y: import_prop_types44.default.shape({
      index: import_prop_types44.default.number,
      value: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number, import_prop_types44.default.string]).isRequired
    })
  }).isRequired,
  classes: import_prop_types44.default.object.isRequired,
  content: import_prop_types44.default.elementType,
  contentProps: import_prop_types44.default.shape({
    axis: import_prop_types44.default.object,
    axisData: import_prop_types44.default.shape({
      x: import_prop_types44.default.shape({
        index: import_prop_types44.default.number,
        value: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number, import_prop_types44.default.string]).isRequired
    ...
    axisValue: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number, import_prop_types44.default.string]),
    classes: import_prop_types44.default.object,
    dataIndex: import_prop_types44.default.number,
    series: import_prop_types44.default.arrayOf(import_prop_types44.default.object),
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime48.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime48.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime48.jsx)(ChartsAxisTooltipContent, {
...
var _excluded37 = ["rotate", "dominantBaseline"];
var _excluded212 = ["label"];
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React83.useMemo(
  ...
  const padding2 = React83.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React83.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded37);
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React83.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
    ...
    const seriesWithRawPosition = seriesToDisplay.map((_ref) => {
      let {
        label
      } = _ref, other = _objectWithoutPropertiesLoose(_ref, _excluded212);
  ...
  return (0, import_jsx_runtime49.jsx)(NoSsr, {
    children: (0, import_jsx_runtime49.jsx)(ChartsLegendRoot, {
      ...
      children: seriesWithPosition.map(({
        ...
        children: [(0, import_jsx_runtime49.jsx)("rect", {
          className: classes.mark,
          ...
          fill: color3
        }), (0, import_jsx_runtime49.jsx)(ChartsText, {
          style: labelStyle,
          text: label,
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types46.default.oneOf(["column", "row"]).isRequired,
  drawingArea: import_prop_types46.default.shape({
    bottom: import_prop_types46.default.number.isRequired,
    height: import_prop_types46.default.number.isRequired,
    left: import_prop_types46.default.number.isRequired,
    right: import_prop_types46.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types46.default.arrayOf(import_prop_types46.default.shape({
...
function ChartsLegend(inProps) {
  ...
  const theme = useTheme4();
  const classes = useUtilityClasses10(_extends({}, props, {
    theme
  }));
  const drawingArea = useDrawingArea();
  const series = React84.useContext(SeriesContext);
...
function ChartsAxisHighlight(props) {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React85.useContext(CartesianContext);
  ...
  return (0, import_jsx_runtime51.jsxs)(React85.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime51.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime51.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime51.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime51.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime52.jsx)("clipPath", {
    id,
    children: (0, import_jsx_runtime52.jsx)("rect", {
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React88.useContext(SeriesContext).line;
  const axisData = React88.useContext(CartesianContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime54.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor(series[seriesId], xAxis[xAxisKey], yAxis[yAxisKey]);
        return (0, import_jsx_runtime54.jsx)(Element2, _extends({
          id: seriesId,
...
var _excluded40 = ["vertical", "horizontal"];
...
function ChartsGrid(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React89.useContext(CartesianContext);
  const classes = useUtilityClasses13(themeProps);
  ...
  return (0, import_jsx_runtime55.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && xTicks.map(({
      formattedValue,
      offset: offset2
    }) => (0, import_jsx_runtime55.jsx)(GridLine, {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset2,
      x2: offset2,
...
function ChartsOnAxisClickHandler(props) {
  ...
  const svgRef = React90.useContext(SvgContext);
  const series = React90.useContext(SeriesContext);
  const {
    axis
  ...
  return (0, import_jsx_runtime56.jsx)(React90.Fragment, {});
}
...
var LineChart = React94.forwardRef(function LineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    series,
  ...
  return (0, import_jsx_runtime60.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime60.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid2 && (0, import_jsx_runtime60.jsx)(ChartsGrid, {
      vertical: grid2.vertical,
      horizontal: grid2.horizontal
    }), (0, import_jsx_runtime60.jsxs)("g", {
      ...
      children: [(0, import_jsx_runtime60.jsx)(AreaPlot, {
        ...
        skipAnimation: skipAnimation2
      }), (0, import_jsx_runtime60.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime60.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime60.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime60.jsx)(MarkPlot, {
      slots,
      slotProps,
      ...
      slots,
      slotProps
    })), !loading && (0, import_jsx_runtime60.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime60.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types54.default.shape({
    x: import_prop_types54.default.oneOf(["band", "line", "none"]),
    y: import_prop_types54.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types54.default.oneOfType([import_prop_types54.default.object, import_prop_types54.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types54.default.oneOfType([import_prop_types54.default.arrayOf(import_prop_types54.default.string), import_prop_types54.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types54.default.arrayOf(import_prop_types54.default.object),
   ...
   */
  disableLineItemHighlight: import_prop_types54.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types54.default.shape({
    horizontal: import_prop_types54.default.bool,
    vertical: import_prop_types54.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types54.default.oneOfType([import_prop_types54.default.object, import_prop_types54.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types54.default.shape({
    classes: import_prop_types54.default.object,
    direction: import_prop_types54.default.oneOf(["column", "row"]),
    hidden: import_prop_types54.default.bool,
    position: import_prop_types54.default.shape({
      horizontal: import_prop_types54.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types54.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   */
  onAreaClick: import_prop_types54.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types54.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types54.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types54.default.func,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types54.default.oneOfType([import_prop_types54.default.object, import_prop_types54.default.string]),
  /**
   * The series to display in the line chart.
   * An array of [[LineSeriesType]] objects.
   */
  series: import_prop_types54.default.arrayOf(import_prop_types54.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
   ...
   */
  tooltip: import_prop_types54.default.shape({
    axisContent: import_prop_types54.default.elementType,
    classes: import_prop_types54.default.object,
    itemContent: import_prop_types54.default.elementType,
    slotProps: import_prop_types54.default.object,
    slots: import_prop_types54.default.object,
    trigger: import_prop_types54.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types54.default.oneOfType([import_prop_types54.default.object, import_prop_types54.default.string]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types54.default.arrayOf(import_prop_types54.default.shape({
    axisId: import_prop_types54.default.oneOfType([import_prop_types54.default.number, import_prop_types54.default.string]),
    classes: import_prop_types54.default.object,
    colorMap: import_prop_types54.default.oneOfType([import_prop_types54.default.shape({
      colors: import_prop_types54.default.arrayOf(import_prop_types54.default.string).isRequired,
      type: import_prop_types54.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types54.default.string,
      values: import_prop_types54.default.arrayOf(import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number, import_prop_types54.default.string]).isRequired)
    }), import_prop_types54.default.shape({
      color: import_prop_types54.default.oneOfType([import_prop_types54.default.arrayOf(import_prop_types54.default.string.isRequired), import_prop_types54.default.func]).isRequired,
      max: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
      min: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
      type: import_prop_types54.default.oneOf(["continuous"]).isRequired
    }), import_prop_types54.default.shape({
      colors: import_prop_types54.default.arrayOf(import_prop_types54.default.string).isRequired,
      thresholds: import_prop_types54.default.arrayOf(import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]).isRequired).isRequired,
      type: import_prop_types54.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types54.default.array,
    dataKey: import_prop_types54.default.string,
    disableLine: import_prop_types54.default.bool,
    disableTicks: import_prop_types54.default.bool,
    fill: import_prop_types54.default.string,
    hideTooltip: import_prop_types54.default.bool,
    ...
    labelFontSize: import_prop_types54.default.number,
    labelStyle: import_prop_types54.default.object,
    max: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
    min: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
    position: import_prop_types54.default.oneOf(["bottom", "left", "right", "top"]),
    reverse: import_prop_types54.default.bool,
    scaleType: import_prop_types54.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types54.default.object,
    slots: import_prop_types54.default.object,
    stroke: import_prop_types54.default.string,
    tickFontSize: import_prop_types54.default.number,
    tickInterval: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["auto"]), import_prop_types54.default.array, import_prop_types54.default.func]),
    tickLabelInterval: import_prop_types54.default.oneOfType([import_prop_types54.default.oneOf(["auto"]), import_prop_types54.default.func]),
    tickLabelPlacement: import_prop_types54.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types54.default.object,
    tickMaxStep: import_prop_types54.default.number,
    tickMinStep: import_prop_types54.default.number,
    tickNumber: import_prop_types54.default.number,
    tickPlacement: import_prop_types54.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types54.default.number,
    valueFormatter: import_prop_types54.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types54.default.arrayOf(import_prop_types54.default.shape({
    axisId: import_prop_types54.default.oneOfType([import_prop_types54.default.number, import_prop_types54.default.string]),
    classes: import_prop_types54.default.object,
    colorMap: import_prop_types54.default.oneOfType([import_prop_types54.default.shape({
      colors: import_prop_types54.default.arrayOf(import_prop_types54.default.string).isRequired,
