...
export default function PingPong() {
    ...
    //     </div>
    // )
    // const socket = new WebSocket('ws://localhost:8000/ws/game/room_name/');

    // socket.onmessage = function(event) {
    //     const gameState = JSON.parse(event.data);
    //     // Update React component state with gameState to render paddles and ball
    // };

    // const handlePaddleMove = (newYPosition) => {
    //     socket.send(JSON.stringify({ player: 'paddle1', y: newYPosition }));
    // };
    return (
